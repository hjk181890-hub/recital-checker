...
9. 소요시간: 형식 반드시 MM'SS" (분 반드시 2자리+작은따옴표+초 2자리+큰따옴표). PDF에서 시간 표기를 전수 확인하여 분이 한 자리인 경우(예: 3'08", 4'30", 2'00" 등) 모두 ❌ 오류로 처리. 올바른 형식 예시: 03'08", 04'30", 02'00". 단 10분 이상(예: 10'00", 18'15")은 2자리이므로 통과. Intermission 시간 기재 필수, Intermission 미포함 실연주시간 총합 우측 아래 기재 필수
...
응답형식JSON만: {"items":[{"category":"항목명","status":"pass또는warn또는fail","title":"한줄요약","detail":"설명또는null","suggestion":"수정제안또는null"}],"summary":"총평을 반드시 아래 형식으로 작성:\n1. [첫번째 오류/주의사항]\n2. [두번째 오류/주의사항]\n3. [세번째 오류/주의사항]\n(필요시 계속)\n\n[한 줄 종합 평가]"`;
