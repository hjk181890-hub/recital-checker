...
2. 글꼴·색상: 글자색은 전체 검정(#000000)이어야 함. 위에 제공된 자동 추출 정보의 비검정 글자 건수를 확인하여 1건 이상이면 오류로 처리. 폰트는 제목부=맑은 고딕, 프로그램부=함초롬바탕이어야 함. 비허용 폰트 건수 확인하여 1건 이상이면 오류
...
9. 소요시간: 형식 00'00"(분2자리+작은따옴표+초2자리+큰따옴표), 곡별표기, Intermission 시간 기재, Intermission 시간 미포함 실연주시간 총합 우측 아래에 기재
